...
class setting_config:
    ...
    model_config = {
        ...
        'drop_path_rate': 0.2,
        'load_ckpt_path': '/gpfs/home/WB23301078/mamba/vmunet/VM-UNet-main/pre_trained_weights/vmamba_small_e238_ema.pth',
        'deep_supervision': True,
    }

    datasets = 'polyp'
    if datasets == 'isic18':
        data_path = '/gpfs/home/WB23301078/Dataset/isic1718/isic2018/'
    elif datasets == 'isic17':
        data_path = '/gpfs/home/WB23301078/Dataset/isic1718/isic2017/'
    elif datasets == 'polyp':
        data_path = '/gpfs/home/WB23301078/Dataset/poly/'
    elif datasets == 'gim':
        data_path = '/raid/code/mamba_all/VM-UNet/data/zd-medic/endoscopy/endoscopy_sod/'
    elif datasets == 'isic_all':
        data_path = '/gpfs/home/WB23301078/Dataset/isic1718/all/'
    elif datasets == 'ureter_256':
        data_path = '/gpfs/home/WB23301078/Dataset/ureter_256x256/'
    else:
    ...
    batch_size = 80
    epochs = 300
    experiment_name = 'SkinSTI_Net_' + datasets + '_' + 'test_g_parameter_'

    # work_dir = 'results/' + experiment_name + datetime.now().strftime('%A_%d_%B_%Y_%Hh_%Mm_%Ss') + '/'
    work_dir = 'results/' + experiment_name + datetime.now().strftime('d%d_m%m_y%Y_%Hh_%Mm_%Ss') + '/'
    ...
    #     myRandomVerticalFlip(p=0.3),
    #     myRandomRotation(p=0.3, degree=[-30, 30]),
    ...
    train_transformer = transforms.Compose([
        myNormalize(datasets, train=True),
        myToTensor(),
        myRandomHorizontalFlip(p=0.5),  # 增加水平翻转概率
        myRandomVerticalFlip(p=0.5),  # 适度增加垂直翻转概率
        myRandomRotation(degree=[-90, 90], p=0.6),  # 限制旋转范围
        myResize(input_size_h, input_size_w)
    ])
