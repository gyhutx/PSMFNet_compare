...
from utils import *
from configs.config_setting_synapse_v2 import setting_config
...
def main(config):
    ...
    val_dataset = Synapse_dataset(base_dir=config.volume_path, split="test", list_dir=config.list_dir)
    print("The length of test set is: {}".format(len(val_dataset)))
