...
class VMUNetV2(nn.Module):
    def __init__(self,
        ...
        # 替换为深度可分离卷积
        self.Translayer_1 = DepthwiseSeparableConv(2 * mid_channel, mid_channel, kernel_size=1)
        self.Translayer_2 = DepthwiseSeparableConv(4 * mid_channel, mid_channel, kernel_size=1)
        self.Translayer_3 = DepthwiseSeparableConv(8 * mid_channel, mid_channel, kernel_size=1)
        self.Translayer_4 = DepthwiseSeparableConv(16 * mid_channel, mid_channel, kernel_size=1)
